  ...
  return (
    ...
    >
      <Div>
        ...
        <Text Component='p' weight='regular'>
          &mdash;&nbsp;Отсканировать QR-код, который отображается на&nbsp;телефоне участника-создателя игры,
          а&nbsp;также у&nbsp;всех, кто уже присоединился к&nbsp;комнате;
        </Text>
        <Text Component='p' weight='regular'>
          &mdash;&nbsp;Перейти по&nbsp;ссылке, которую участник-создатель может отправить;
        </Text>
        <Text Component='p' weight='regular'>
          &mdash;&nbsp;Ввести номер комнаты, который также отображается на&nbsp;телефоне у&nbsp;участника-создателя;
        </Text>
        <Text Component='p' weight='regular'>
        ...
        <FormItem style={{ position: 'sticky', bottom: 24 }}>
