    ...
    >
      <Div>
        ...
        <ul className={styles.list}>
          <li>
            Нельзя произносить загаданное слово, использовать его однокоренные слова, называть на&nbsp;иностранном языке
            и указывать на&nbsp;конкретный предмет. Например, если загадано слово <q>стул</q>, то&nbsp;указывать
            на&nbsp;стул нельзя.
          </li>
          <li>
